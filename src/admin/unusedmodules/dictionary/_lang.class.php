...
class lang{
    ...
    public static function dejArray(){
        $query = "SELECT * FROM tbLangs WHERE isActive = 1";
        $data = new sql($query);
        return $data->all();
    }


    public static function dejArray4select(){
        $query = "SELECT * FROM tbLangs WHERE isActive = 1";
        $data = new sql($query);
       $out = array();
    ...
    public static function dejList($page, $query){
         $num = 100;
         $page = ($page-1)*$num;
    ...
    public static function buttons($source, $page){
  ...
  static  function short($id){
      ...
      public static function langsOut(){
