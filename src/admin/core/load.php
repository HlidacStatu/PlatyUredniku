...
require_once dirname(__FILE__) . "/../modules/aktuality/_config.php";
require_once dirname(__FILE__) . "/../modules/files/_config.php";
require_once dirname(__FILE__) . "/../modules/formulare/_config.php";
require_once dirname(__FILE__) . "/../modules/home/_config.php";
require_once dirname(__FILE__) . "/../modules/instituce/_config.php";
require_once dirname(__FILE__) . "/../modules/institucedruh/_config.php";
require_once dirname(__FILE__) . "/../modules/pages/_config.php";
require_once dirname(__FILE__) . "/../modules/platy/_config.php";
require_once dirname(__FILE__) . "/../modules/pozice/_config.php";
require_once dirname(__FILE__) . "/../modules/users/_config.php";
