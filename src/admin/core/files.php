...
class files{
  ...
  public static function dejList($page, $search="", $filtr=""){
        $num = 100;
        $page = ($page-1)*$num;
       ...
       foreach($data->all() as $zaznam){
            $out .=' 
                <div class="box file a" data="'.$zaznam["id"].'">
                    <div class="icon" style="background-image: url('.iconFile($zaznam["link"], "small").')"></div>
                    <div class="data">
                    ...
                    <div class="info">
                        ...
                        <div class=icon>'.iconFile($zaznam["link"]).'</div>
  ...
  public static function humanType($extension){
        $out = "Various";
       if (strtolower($extension) == "gif") {$out = "obr";         }
       if (strtolower($extension) == "jpeg") {$out = "obr";        }
       if (strtolower($extension) == "jpg") {$out = "obr";         }
       if (strtolower($extension) == "png") {$out = "obr";         }
